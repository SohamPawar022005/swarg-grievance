...
export const complaints: Complaint[] = [
  {
    id: 'GRV-2025-001', title: 'Water supply disruption in Ward 5',
    description: 'No water supply for 3 days in Sector B, Ward 5.',
    category: 'water', location: { area: 'Ward 5, Sector B', district: 'Varanasi', state: 'Uttar Pradesh' },
    priority: 'high', status: 'assigned', currentLevel: 'local', assignedTo: 'L001', citizenId: 'C001',
    createdAt: '2025-03-20T09:00:00Z', slaDeadline: '2025-03-23T09:00:00Z', escalationHistory: [],
  },
  {
    id: 'GRV-2025-002', title: 'Pothole on main road near market',
    description: 'Large pothole causing accidents near Aminabad market.',
    category: 'roads', location: { area: 'Aminabad', district: 'Lucknow', state: 'Uttar Pradesh' },
    priority: 'medium', status: 'escalated', currentLevel: 'district', assignedTo: 'D002', citizenId: 'C002',
    createdAt: '2025-03-15T11:30:00Z', slaDeadline: '2025-03-20T11:30:00Z',
    escalationHistory: [
      { from: 'local', to: 'district', timestamp: '2025-03-18T14:00:00Z', reason: 'SLA breach - no action taken at local level' },
    ],
  },
  {
    id: 'GRV-2025-003', title: 'Dengue outbreak in Ward 12',
    description: 'Multiple dengue cases reported. Fogging not done.',
    category: 'health', location: { area: 'Ward 12', district: 'Lucknow', state: 'Uttar Pradesh' },
    priority: 'emergency', status: 'escalated', currentLevel: 'state', assignedTo: 'S002', citizenId: 'C002',
    createdAt: '2025-03-10T08:00:00Z', slaDeadline: '2025-03-12T08:00:00Z',
    escalationHistory: [
  ...
  {
    id: 'GRV-2025-004', title: 'Blocked drainage in residential area',
    description: 'Sewage overflow in Block C residential colony.',
    category: 'sanitation', location: { area: 'Block C, Kidwai Nagar', district: 'Kanpur', state: 'Uttar Pradesh' },
    priority: 'high', status: 'pending', currentLevel: 'local', assignedTo: '', citizenId: 'C003',
    createdAt: '2025-03-22T07:30:00Z', slaDeadline: '2025-03-25T07:30:00Z', escalationHistory: [],
  },
  {
    id: 'GRV-2025-005', title: 'Street lights not working',
    description: 'Street lights in entire ward are off for 1 week.',
    category: 'electricity', location: { area: 'Ward 8', district: 'Varanasi', state: 'Uttar Pradesh' },
    priority: 'medium', status: 'resolved', currentLevel: 'local', assignedTo: 'L001', citizenId: 'C001',
    createdAt: '2025-03-05T16:00:00Z', slaDeadline: '2025-03-08T16:00:00Z', escalationHistory: [],
  },
  {
    id: 'GRV-2025-006', title: 'School building roof leaking',
    description: 'Government primary school roof damaged, classes disrupted.',
    category: 'education', location: { area: 'Gomti Nagar', district: 'Lucknow', state: 'Uttar Pradesh' },
    priority: 'high', status: 'assigned', currentLevel: 'district', assignedTo: 'D002', citizenId: 'C002',
    createdAt: '2025-03-18T10:00:00Z', slaDeadline: '2025-03-22T10:00:00Z',
    escalationHistory: [
      { from: 'local', to: 'district', timestamp: '2025-03-19T12:00:00Z', reason: 'Requires district-level PWD intervention' },
    ],
  },
  {
    id: 'GRV-2025-007', title: 'Contaminated water supply',
    description: 'Yellow/brownish water being supplied through municipal pipes.',
    category: 'water', location: { area: 'Civil Lines', district: 'Varanasi', state: 'Uttar Pradesh' },
    priority: 'emergency', status: 'escalated', currentLevel: 'compliance', assignedTo: 'CO001', citizenId: 'C001',
    createdAt: '2025-03-01T06:00:00Z', slaDeadline: '2025-03-03T06:00:00Z',
    escalationHistory: [
  ...
  {
    id: 'GRV-2025-008', title: 'Garbage not collected for 10 days',
    description: 'No garbage collection in Ward 3 for over 10 days.',
    category: 'sanitation', location: { area: 'Ward 3', district: 'Kanpur', state: 'Uttar Pradesh' },
    priority: 'medium', status: 'assigned', currentLevel: 'local', assignedTo: 'L001', citizenId: 'C003',
    createdAt: '2025-03-21T09:00:00Z', slaDeadline: '2025-03-24T09:00:00Z', escalationHistory: [],
  },
];
